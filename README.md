...
- [4. GNN](#4-gnn)
  ...
  * [Graphs and where to find them](#graphs-and-where-to-find-them)
- [5. GAN](#5-gan)
  * [The Architecture](#the-architecture-3)
  * [The Generator Model](#the-generator-model)
  * [The Discriminator Model](#the-discriminator-model)
  * [GANs as a Two-Player Game](#gans-as-a-two-player-game)
...
[GAN](https://papers.nips.cc/paper_files/paper/2014/file/5ca3e9b122f61f8f06494c97b1afccf3-Paper.pdf), or Generative Adversarial Networks, is a deep-learning-based generative model, designed by *Ian J. Goodfellow*, *Jean Pouget-Abadie*, *Mehdi Mirza*, *Bing Xu*, *Llion Jones*, *David Warde-Farley*, *Sherjil Ozair*, * Aaron Courville* and *Yoshua Bengio*. Transformer learns context and thus meaning by tracking relationships in sequential data like the words in the sentence.
...
<div align="center">
<img src="https://user-images.githubusercontent.com/104020492/231338944-ca988c06-7050-4dc0-98cc-97f699d89f16.png" width="60%" height="60%" />
</div>
...
The generative process is seeded with a vector that is randomly selected from a Gaussian distribution. After training, points in this multidimensional vector space will correspond to points in the problem domain, forming a compressed representation of the data distribution.

<div align="center">
<img src="https://user-images.githubusercontent.com/104020492/231341020-f1691a31-1e11-4017-b799-de177b51e8ee.png" width="30%" height="40%" />
</div>
...
<div align="center">
<img src="https://user-images.githubusercontent.com/104020492/231351651-f18984ff-06e9-42d8-a491-314c6e2c9c56.png" width="30%" height="40%" />
</div>
...
<div align="center">
<img src="https://user-images.githubusercontent.com/104020492/231352269-f926fc52-daa6-4a40-815d-e17ef734f968.png" width="40%" height="40%" />
</div>

You can find the code in this [web](https://paperswithcode.com/paper/generative-adversarial-networks).
